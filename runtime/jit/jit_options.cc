...
static constexpr uint32_t kJitDefaultOptimizeThreshold = 0xffff / 2;
...
static constexpr uint32_t kJitDefaultWarmupThreshold = 0xffff / 2;
...
static constexpr size_t kDefaultPriorityThreadWeightRatio = 500;
